...
// Constructor for 595 Shift Register driving SN76489 with SER, LATCH, Clock and !RW
SN76489::SN76489(uint8_t PIN_NotWE,uint8_t PIN_SER,uint8_t PIN_LATCH,uint8_t PIN_CLK,float N) : SN76489(PIN_NotWE,PIN_SER,PIN_LATCH,PIN_CLK,N,255) {}
...
void SN76489::setDivider(uint8_t toneGenerator, uint16_t divider) {
  byte n0;
  byte n1 = 0;
